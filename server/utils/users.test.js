...
describe('Users', () => {
    ...
    it('should add new user', () => {
        ...
        //first users is var users = new Users();
        //second one access users array 
    ...
    it('should remove a user', () => {
        ...
        // expect(res).toEqual(expect.not.objectContaining(users.users[0]));
        var userId = '1';
    ...
    it('should not remove user id id doesnt exist', () => {
        // var userId = '6';
        // var res = users.removeUser(userId);
        // expect(res).toEqual(users.users);
        var userId = '6';
        var user = users.removeUser(userId);
